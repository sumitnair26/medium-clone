...
export const Appbar = () => {
    ...
    return <div className="border-b flex justify-between px-10 py-4" >
        ...
        <div className="flex">
            ...
            <svg className="w-8 h-8 px-px text-gray-800 cursor-pointer" onClick={Logout} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" id="logout">
