        ...
        <div className="w-full mb-4 border">
            <div className="flex items-center justify-between ">
                <div className="my-2 bg-white rounded-b-lg w-full">
                    ...
                    <textarea onChange={onChange} id="editor" rows="8" className="focus:outline-none block w-full px-0 text-sm text-gray-800 bg-white border-0 focus:ring-0 pl-2" placeholder="Write an article..." required />
                </div>
             </div>
        </div>
        </div>
